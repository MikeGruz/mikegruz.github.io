...
```{r state.boundaries, message=FALSE}
...
```{r stateplot, warning = FALSE, message=FALSE, dev='svg', fig.width=6, fig.height=4}
...
```{r countyplot, warning = FALSE, dev='svg', fig.width=6, fig.height=4}
...
```{r county.elect.map, warning = FALSE, dev='svg', fig.width=8, fig.height=6}
